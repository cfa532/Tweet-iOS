...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphonesimulator clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-programs --disable-ffplay --disable-ffprobe --disable-ffmpeg --disable-doc --disable-debug --disable-avdevice --enable-pic --enable-encoder=h264 --enable-encoder=aac --enable-decoder=h264 --enable-decoder=aac --enable-demuxer=mov --enable-demuxer=mp4 --enable-demuxer=avi --enable-demuxer=matroska --enable-demuxer=flv --enable-demuxer=mpegts --enable-demuxer=rm --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=hls --enable-protocol=file --enable-filter=scale --extra-cflags='-arch arm64 -mios-simulator-version-min=16.0' --extra-ldflags='-arch arm64 -mios-simulator-version-min=16.0' --prefix=.
prefix=.
...
CXX=g++
AS=gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphonesimulator clang
OBJCC=xcrun -sdk iphonesimulator clang
LD=xcrun -sdk iphonesimulator clang
DEPCC=xcrun -sdk iphonesimulator clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphonesimulator clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS=  -arch arm64 -mios-simulator-version-min=16.0 -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -arch arm64 -mios-simulator-version-min=16.0 -fPIC -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-simulator-version-min=16.0  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
