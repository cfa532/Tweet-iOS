...
enum AVChannel {
     ...
     *
     * Given a channel id <i>i</i> between AV_CHAN_AMBISONIC_BASE and
     * AV_CHAN_AMBISONIC_END (inclusive), the ACN index of the channel <i>n</i> is
     * <i>n = i - AV_CHAN_AMBISONIC_BASE</i>.
     *
...
// #define AV_CH_LAYOUT_3POINT1POINT2          AV_CHANNEL_LAYOUT_MASK(6,  AV_CH_LAYOUT_3POINT1POINT2)
